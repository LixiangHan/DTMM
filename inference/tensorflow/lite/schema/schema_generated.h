...
struct CompressedSparseRowBuilder;
struct CompressedSparseRowT;
...
struct CompressedSparseRowT : public flatbuffers::NativeTable {
  typedef CompressedSparseRow TableType;
  std::vector<int16_t> row_ptr{};
  std::vector<int16_t> col_idx{};
  uint16_t input_ch = 0;
};

struct CompressedSparseRow FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef CompressedSparseRowT NativeTableType;
  typedef CompressedSparseRowBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ROW_PTR = 4,
    VT_COL_IDX = 6,
    VT_INPUT_CH = 8
  };
  const flatbuffers::Vector<int16_t> *row_ptr() const {
    return GetPointer<const flatbuffers::Vector<int16_t> *>(VT_ROW_PTR);
  }
  const flatbuffers::Vector<int16_t> *col_idx() const {
    return GetPointer<const flatbuffers::Vector<int16_t> *>(VT_COL_IDX);
  }
  uint16_t input_ch() const {
    return GetField<uint16_t>(VT_INPUT_CH, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_ROW_PTR) &&
           verifier.VerifyVector(row_ptr()) &&
           VerifyOffset(verifier, VT_COL_IDX) &&
           verifier.VerifyVector(col_idx()) &&
           VerifyField<uint16_t>(verifier, VT_INPUT_CH) &&
           verifier.EndTable();
  }
  CompressedSparseRowT *UnPack(const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(CompressedSparseRowT *_o, const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<CompressedSparseRow> Pack(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparseRowT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};

struct CompressedSparseRowBuilder {
  typedef CompressedSparseRow Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_row_ptr(flatbuffers::Offset<flatbuffers::Vector<int16_t>> row_ptr) {
    fbb_.AddOffset(CompressedSparseRow::VT_ROW_PTR, row_ptr);
  }
  void add_col_idx(flatbuffers::Offset<flatbuffers::Vector<int16_t>> col_idx) {
    fbb_.AddOffset(CompressedSparseRow::VT_COL_IDX, col_idx);
  }
  void add_input_ch(uint16_t input_ch) {
    fbb_.AddElement<uint16_t>(CompressedSparseRow::VT_INPUT_CH, input_ch, 0);
  }
  explicit CompressedSparseRowBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<CompressedSparseRow> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<CompressedSparseRow>(end);
    return o;
  }
};

inline flatbuffers::Offset<CompressedSparseRow> CreateCompressedSparseRow(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<int16_t>> row_ptr = 0,
    flatbuffers::Offset<flatbuffers::Vector<int16_t>> col_idx = 0,
    uint16_t input_ch = 0) {
  CompressedSparseRowBuilder builder_(_fbb);
  builder_.add_col_idx(col_idx);
  builder_.add_row_ptr(row_ptr);
  builder_.add_input_ch(input_ch);
  return builder_.Finish();
}

inline flatbuffers::Offset<CompressedSparseRow> CreateCompressedSparseRowDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<int16_t> *row_ptr = nullptr,
    const std::vector<int16_t> *col_idx = nullptr,
    uint16_t input_ch = 0) {
  auto row_ptr__ = row_ptr ? _fbb.CreateVector<int16_t>(*row_ptr) : 0;
  auto col_idx__ = col_idx ? _fbb.CreateVector<int16_t>(*col_idx) : 0;
  return tflite::CreateCompressedSparseRow(
      _fbb,
      row_ptr__,
      col_idx__,
      input_ch);
...
flatbuffers::Offset<CompressedSparseRow> CreateCompressedSparseRow(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparseRowT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct SparsityParametersT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<tflite::CompressedSparseRowT> compressed_sparse_row{};
...
struct SparsityParameters FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const tflite::CompressedSparseRow *compressed_sparse_row() const {
    return GetPointer<const tflite::CompressedSparseRow *>(VT_COMPRESSED_SPARSE_ROW);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_COMPRESSED_SPARSE_ROW) &&
           verifier.VerifyTable(compressed_sparse_row()) &&
           verifier.EndTable();
  }
...
struct SparsityParametersBuilder {
  ...
  void add_compressed_sparse_row(flatbuffers::Offset<tflite::CompressedSparseRow> compressed_sparse_row) {
    fbb_.AddOffset(SparsityParameters::VT_COMPRESSED_SPARSE_ROW, compressed_sparse_row);
  }
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParameters(
    ...
    flatbuffers::Offset<tflite::CompressedSparseRow> compressed_sparse_row = 0) {
  SparsityParametersBuilder builder_(_fbb);
  builder_.add_compressed_sparse_row(compressed_sparse_row);
...
inline CompressedSparseRowT *CompressedSparseRow::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<CompressedSparseRowT>(new CompressedSparseRowT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void CompressedSparseRow::UnPackTo(CompressedSparseRowT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = row_ptr(); if (_e) { _o->row_ptr.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->row_ptr[_i] = _e->Get(_i); } } }
  { auto _e = col_idx(); if (_e) { _o->col_idx.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->col_idx[_i] = _e->Get(_i); } } }
  { auto _e = input_ch(); _o->input_ch = _e; }
}

inline flatbuffers::Offset<CompressedSparseRow> CompressedSparseRow::Pack(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparseRowT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateCompressedSparseRow(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<CompressedSparseRow> CreateCompressedSparseRow(flatbuffers::FlatBufferBuilder &_fbb, const CompressedSparseRowT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const CompressedSparseRowT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _row_ptr = _o->row_ptr.size() ? _fbb.CreateVector(_o->row_ptr) : 0;
  auto _col_idx = _o->col_idx.size() ? _fbb.CreateVector(_o->col_idx) : 0;
  auto _input_ch = _o->input_ch;
  return tflite::CreateCompressedSparseRow(
      _fbb,
      _row_ptr,
      _col_idx,
...
inline SparsityParametersT::SparsityParametersT(const SparsityParametersT &o)
      : traversal_order(o.traversal_order),
        ...
        compressed_sparse_row((o.compressed_sparse_row) ? new tflite::CompressedSparseRowT(*o.compressed_sparse_row) : nullptr) {
...
inline SparsityParametersT &SparsityParametersT::operator=(SparsityParametersT o) FLATBUFFERS_NOEXCEPT {
  ...
  std::swap(compressed_sparse_row, o.compressed_sparse_row);
  return *this;
}
...
inline void SparsityParameters::UnPackTo(SparsityParametersT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = compressed_sparse_row(); if (_e) { if(_o->compressed_sparse_row) { _e->UnPackTo(_o->compressed_sparse_row.get(), _resolver); } else { _o->compressed_sparse_row = std::unique_ptr<tflite::CompressedSparseRowT>(_e->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParameters(flatbuffers::FlatBufferBuilder &_fbb, const SparsityParametersT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _compressed_sparse_row = _o->compressed_sparse_row ? CreateCompressedSparseRow(_fbb, _o->compressed_sparse_row.get(), _rehasher) : 0;
  return tflite::CreateSparsityParameters(
      _fbb,
      _traversal_order,
      _block_map,
      _dim_metadata,
      _compressed_sparse_row);
}
...
inline SignatureDefT &SignatureDefT::operator=(SignatureDefT o) FLATBUFFERS_NOEXCEPT {
  std::swap(inputs, o.inputs);
  std::swap(outputs, o.outputs);
  std::swap(method_name, o.method_name);
  std::swap(key, o.key);
