...
class SparsityParameters(object):
    ...
    # SparsityParameters
    def CompressedSparseRow(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(10))
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from tflite.CompressedSparseRow import CompressedSparseRow
            obj = CompressedSparseRow()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def SparsityParametersAddCompressedSparseRow(builder, compressedSparseRow): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(compressedSparseRow), 0)
def AddCompressedSparseRow(builder, compressedSparseRow):
    return SparsityParametersAddCompressedSparseRow(builder, compressedSparseRow)
def SparsityParametersEnd(builder): return builder.EndObject()
def End(builder):
    return SparsityParametersEnd(builder)
import tflite.CompressedSparseRow
...
class SparsityParametersT(object):
    ...
    def __init__(self):
        ...
        self.compressedSparseRow = None  # type: Optional[tflite.CompressedSparseRow.CompressedSparseRowT]
    ...
    def _UnPack(self, sparsityParameters):
        ...
        if sparsityParameters.CompressedSparseRow() is not None:
            self.compressedSparseRow = tflite.CompressedSparseRow.CompressedSparseRowT.InitFromObj(sparsityParameters.CompressedSparseRow())
    ...
    def Pack(self, builder):
        ...
        if self.compressedSparseRow is not None:
            compressedSparseRow = self.compressedSparseRow.Pack(builder)
        ...
        if self.compressedSparseRow is not None:
            SparsityParametersAddCompressedSparseRow(builder, compressedSparseRow)
